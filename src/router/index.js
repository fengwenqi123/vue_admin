...
},
{
  ...
  children: [{
    ...
    children: [{
      ...
      name: 'levelOne',
      component: () =>
                        import('@/views/dashboard/level_one/index'),
    ...
    },
    {
      ...
      name: 'monitor',
      component: () =>
                        import('@/views/dashboard/level_two/essential/Monitor/index'),
    ...
    },
    {
      ...
      name: 'wharf',
      component: () =>
                        import('@/views/dashboard/level_two/essential/wharf/index'),
    ...
    },
    {
      ...
      name: 'materials',
      component: () =>
                        import('@/views/dashboard/level_two/essential/material/index'),
    ...
    },
    {
      ...
      name: 'station',
      component: () =>
                        import('@/views/dashboard/level_two/essential/station/index'),
    ...
    },
    {
      ...
      name: 'AIS',
      component: () =>
                        import('@/views/dashboard/level_two/essential/AIS/index'),
    ...
    },
    {
      ...
      name: 'VHF',
      component: () =>
                        import('@/views/dashboard/level_two/essential/VHF/index'),
      ...
      name: 'berth',
      component: () =>
                        import('@/views/dashboard/level_two/essential/berth/index'),
    ...
    },
    {
      ...
      name: 'kakou',
      component: () =>
                        import('@/views/dashboard/level_two/kakou/index'),
    ...
    },
    {
      ...
      component: () =>
                        import('@/views/dashboard/level_two/shipInformation/index'),
    ...
    },
    {
      ...
      name: 'region',
      component: () =>
                        import('@/views/dashboard/level_two/region/index'),
    ...
    },
    {
      ...
      name: 'QJsupervise',
      component: () =>
                        import('@/views/dashboard/level_two/QJsupervise/index'),
    ...
    name: 'QjList',
    component: () =>
                import('@/views/dashboard/level_two/QJsupervise/QjList'),
...
export const asyncRouterMap = [{
  ...
  children: [{
    ...
    name: 'shipRegister',
    component: () =>
                    import('@/views/shipManage/shipRegister'),
  ...
  },
  {
    ...
    name: 'shipCollection',
    component: () =>
                    import('@/views/shipManage/shipCollection'),
  ...
  },
  {
    ...
    name: 'shipVoyage',
    component: () =>
                    import('@/views/shipManage/shipVoyage'),
  ...
  },
  {
    ...
    name: 'shipIllegal',
    component: () =>
                    import('@/views/shipManage/shipIllegal'),
  ...
  },
  {
    ...
    name: 'Tracking',
    component: () =>
                    import('@/views/shipManage/Tracking'),
  ...
  },
  {
    ...
    name: 'shipBrand',
    component: () =>
                    import('@/views/shipManage/shipBrand'),
  ...
  },
  {
    ...
    name: 'shipIntegrated',
    component: () =>
                    import('@/views/shipManage/shipIntegrated/index.vue'),
...
},
{
  ...
  children: [{
    ...
    name: 'Registered',
    component: () =>
                    import('@/views/CrewManagement/Registered/index.vue'),
  ...
  },
  {
    ...
    name: 'CrewStatus',
    component: () =>
                    import('@/views/CrewManagement/CrewStatus'),
  ...
  },
  {
    ...
    component: () =>
                    import('@/views/CrewManagement/InformationCollection'),
...
},
{
  ...
  },
  {
    ...
    name: 'FieldCruise',
    component: () =>
                    import('@/views/securityManagement/FieldCruise'),
  ...
  },
  {
    ...
    component: () =>
                    import('@/views/ElectronicCruise/index'),
  ...
  },
  {
    ...
    name: 'supervision',
    component: () =>
                    import('@/views/supervision/index'),
  ...
  },
  {
    ...
    name: 'prevention',
    component: () =>
                    import('@/views/Rsupervise/prevention'),
  ...
  },
  {
    ...
    name: 'NavigationMon',
    component: () =>
                    import('@/views/NavigationMon/index'),
  ...
  },
  {
    ...
    name: 'quyuList',
    component: () =>
                    import('@/views/kakouList/quyu.vue'),
  ...
  },
  {
    ...
    name: 'kakouDetails',
    component: () =>
                    import('@/views/kakouList/kakouDetails'),
  ...
  },
  {
    ...
    name: 'quyuDetails',
    component: () =>
                    import('@/views/kakouList/quyuDetails'),
...
},
{
  ...
  children: [{
    ...
    name: 'Meteorological',
    component: () =>
                    import('@/views/NavigationManagement/Meteorological'),
  ...
  },
  {
    ...
    name: 'activities',
    component: () =>
                    import('@/views/NavigationManagement/activities'),
  ...
  },
  {
    ...
    name: 'restrictedArea',
    component: () =>
                    import('@/views/NavigationManagement/restrictedArea'),
  ...
  },
  {
    ...
    name: 'security',
    component: () =>
                    import('@/views/NavigationManagement/security'),
  ...
  },
  {
    ...
    component: () =>
                    import('@/views/NavigationManagement/NavigationalWarning'),
  ...
  },
  {
    ...
    name: 'GateControl',
    component: () =>
                    import('@/views/NavigationManagement/GateControl'),
  ...
  },
  {
    ...
    name: 'Anchorage',
    component: () =>
                    import('@/views/NavigationManagement/Anchorage'),
    meta: { title: '锚地/服务区', icon: 'tree', roles: ['thgl:md'] }
  },
  {
    path: '/factor',
    component: () =>
                    import('@/views/factor/index'),
    ...
    children: [{
      ...
      name: 'spjk',
      component: () =>
                            import('@/views/factor/video/index'),
    ...
    },
    {
      ...
      name: 'Announcement',
      component: () =>
                            import('@/views/factor/Announcement'),
...
},
{
  ...
  children: [{
    ...
    name: 'goods',
    component: () =>
                    import('@/views/DangerManagement/goods'),
  ...
  },
  {
    ...
    name: 'sewage',
    component: () =>
                    import('@/views/DangerManagement/sewage'),
  ...
  },
  {
    ...
    name: 'PollutantPoint',
    component: () =>
                    import('@/views/DangerManagement/PollutantPoint'),
  ...
  },
  {
    ...
    name: 'twoMembers',
    component: () =>
                    import('@/views/DangerManagement/twoMembers'),
...
},
{
  ...
  children: [{
    ...
    name: 'Checking',
    component: () =>
                    import('@/views/securityManagement/Checking'),
  ...
  },
  {
    ...
    name: 'shipInspection',
    component: () =>
                    import('@/views/securityManagement/shipInspection'),
  ...
  },
  {
    ...
    component: () =>
                    import('@/views/securityManagement/shipSupervision'),
  ...
  },
  {
    ...
    name: 'shipSafety',
    component: () =>
                    import('@/views/securityManagement/shipSafety'),
...
},
{
  ...
  children: [{
    ...
    name: 'Commuter',
    component: () =>
                    import('@/views/CommandDispatch/Commuter'),
    meta: { title: '通勤管理', icon: 'tree', roles: ['zhdd:tqgl'] },
    children: [{
      path: 'Schedule',
      name: 'Schedule',
      component: () =>
                            import('@/views/CommandDispatch/Commuter/Schedule'),
    ...
    },
    {
      ...
      name: 'ClassSetting',
      component: () =>
                            import('@/views/CommandDispatch/Commuter/ClassSetting'),
    ...
    },
    {
      ...
      name: 'Attendance',
      component: () =>
                            import('@/views/CommandDispatch/Commuter/Attendance'),
  ...
  },
  {
    ...
    name: 'UnifiedAlarm',
    component: () =>
                    import('@/views/CommandDispatch/UnifiedAlarm'),
  ...
  },
  {
    ...
    name: 'scheduling',
    component: () =>
                    import('@/views/CommandDispatch/scheduling'),
  ...
  },
  {
    ...
    component: () =>
                    import('@/views/CommandDispatch/InformationDelivery'),
  ...
  },
  {
    ...
    name: 'EmergencyPlan',
    component: () =>
                    import('@/views/CommandDispatch/EmergencyPlan'),
  ...
  },
  {
    ...
    component: () =>
                    import('@/views/CommandDispatch/EmergencyResources'),
...
},
{
  ...
  children: [{
    ...
    name: 'Comprehensive',
    component: () =>
                    import('@/views/decisionAnalysis/Comprehensive'),
  ...
  },
  {
    ...
    name: 'electronic',
    component: () =>
                    import('@/views/decisionAnalysis/electronic'),
  ...
  },
  {
    ...
    component: () =>
                    import('@/views/decisionAnalysis/dangerousGoodsEntering'),
...
},
{
  ...
  children: [{
    ...
    name: 'Process',
    component: () =>
                    import('@/views/BasicEngine/Process'),
  ...
  },
  {
    ...
    name: 'officials',
    component: () =>
                    import('@/views/BasicEngine/officials'),
  ...
  },
  {
    ...
    component: () =>
                    import('@/views/SectionManagement/index'),
  ...
  },
  {
    ...
    name: 'bayonetControl',
    component: () =>
                    import('@/views/SectionManagement/bayonetControl'),
    meta: { title: '卡口执勤管理', icon: 'tree' }
  },
  {
    path: 'onDuty',
    name: 'onDuty',
    component: () =>
                    import('@/views/SectionManagement/bayonetControl/control.vue'),
    meta: { title: '卡口执勤', icon: 'tree' },
    hidden: true
  },
  {
    ...
    component: () =>
                    import('@/views/SectionManagement/JurisdictionManagement'),
...
},
{
  ...
  children: [
    ...
    // },
    {
      ...
      component: () =>
                    import('@/views/AuthorizeManagement/index'),
    ...
    },
    {
      ...
      name: 'RoleManagement',
      component: () =>
                    import('@/views/RoleManagement/index'),
    ...
    },
    {
      ...
      name: 'DepManagement',
      component: () =>
                    import('@/views/DepManagement/index'),
    ...
    },
    {
      ...
      name: 'DicManagement',
      component: () =>
                    import('@/views/DicManagement/index'),
