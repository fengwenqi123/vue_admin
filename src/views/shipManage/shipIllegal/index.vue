...
<script>
  ...
  import {lists, delt, enable, disable} from '@/api/shipIllegal'
  ...
  export default {
    ...
    methods: {
      ...
      list() {
        lists(this.page.pageNum, this.page.pageSize, this.order, this.sort, this.keyword, this.status).then(response => {
