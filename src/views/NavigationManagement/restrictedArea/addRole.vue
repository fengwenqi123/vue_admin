<template>
  <div class="roleModification">
    <el-form ref="form" :model="form" label-width="200px" label-suffix=":">
      ...
      <el-form-item label=" 禁航对象 ">
        <el-input v-model="form.prohibitObj"></el-input>
      </el-form-item>
      ...
      <el-form-item label="信号覆盖情况  ">
        <el-input v-model="form.signCover"></el-input>
      </el-form-item>
      <el-form-item label="AIS信号覆盖情况   ">
        <el-input v-model="form.aisCover"></el-input>
      </el-form-item>
      <el-form-item label=" CCTV信号覆盖情况  ">
        <el-input v-model="form.cctvCover"></el-input>
      </el-form-item>
...
<script>
  ...
  import {mod} from '@/api/restrictedArea.js'
