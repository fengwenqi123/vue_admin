<template>
  <div class="AccountManagement">
    ...
    <el-card class="main">
        ...
        <div class="table">
          <el-table
            ...
            <el-table-column
              ...
              sortable>
              <template slot-scope="scope">
                <div class="nei" @click="openDetails(scope.row)">{{scope.row.loginName}}</div>
              </template>
            </el-table-column>
            <el-table-column
              prop="name"
      ...
      <add-account v-if="!show" @ievent="ievent" :mul="mul" :disabled="disabled"></add-account>
    </el-card>
  </div>
</template>
...
<script>
  ...
  import {lists, delt, enable, disable, resetpassword} from '@/api/AccountManagement'
