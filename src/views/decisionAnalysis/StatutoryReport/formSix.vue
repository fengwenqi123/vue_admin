      ...
      <div class="list">
        <div class="table">
          <el-table
            ...
            <el-table-column label="按作业位置统计">
              <el-table-column label="合计">
                <el-table-column label="天数"></el-table-column>
                <el-table-column label="件数"></el-table-column>
              </el-table-column>
              <el-table-column label="港地">
                <el-table-column label="天数"></el-table-column>
                <el-table-column label="件数"></el-table-column>
              </el-table-column>
              <el-table-column label="锚地">
                <el-table-column label="天数"></el-table-column>
                <el-table-column label="件数"></el-table-column>
              </el-table-column>
              <el-table-column label="航道">
                <el-table-column label="天数"></el-table-column>
                <el-table-column label="件数"></el-table-column>
              </el-table-column>
            ...
            <el-table-column label="按作业方式统计">
              <el-table-column label="扫海">
                <el-table-column label="天数"></el-table-column>
                <el-table-column label="件数"></el-table-column>
              </el-table-column>
              <el-table-column label="疏浚">
                <el-table-column label="天数"></el-table-column>
                <el-table-column label="件数"></el-table-column>
              </el-table-column>
              <el-table-column label="填埋">
                <el-table-column label="天数"></el-table-column>
                <el-table-column label="件数"></el-table-column>
              </el-table-column>
              <el-table-column label="爆破">
                <el-table-column label="天数"></el-table-column>
                <el-table-column label="件数"></el-table-column>
              </el-table-column>
              <el-table-column label="桩基">
                <el-table-column label="天数"></el-table-column>
                <el-table-column label="件数"></el-table-column>
              </el-table-column>
                <el-table-column label="吊装">
                <el-table-column label="天数"></el-table-column>
                <el-table-column label="件数"></el-table-column>
              </el-table-column>
                <el-table-column label="其他">
