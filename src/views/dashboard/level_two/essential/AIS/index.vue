          ...
          <ul class="clearfix ul_big">
            <el-scrollbar class="scrolls">
              <li v-for="(item,index) in dataList" :key="index">
                <div class="modal">
                  <div class="left">
                    <p @click="gis('aisBase',item.name)">{{item.name}}</p>
                    <el-row :gutter="20">
                      <el-col :span="12">
                        <div class="grid-content bg-purple"><span>联系人</span><span>{{item.contact}}</span></div>
                      </el-col>
                      <el-col :span="12">
                        <div class="grid-content bg-purple"><span>经度</span><span>{{item.lon}}</span></div>
                      </el-col>
                      <el-col :span="12">
                        <div class="grid-content bg-purple"><span>联系电话</span><span>{{item.telephone}}</span></div>
                      </el-col>
                      <el-col :span="12">
                        <div class="grid-content bg-purple"><span>纬度</span><span>{{item.lat}}</span></div>
                      </el-col>
                    </el-row>
                  </div>
                  <div class="right">
...
<script>
  ...
  import {lists} from '@/api/AIS.js'
  import pagination from '@/components/pagination/index'
  import det from '@/views/dashboard/level_two/essential/AIS/details'
