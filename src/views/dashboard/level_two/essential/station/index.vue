        ...
        <ul class="clearfix ul_big">
          <el-scrollbar class="scrolls">
            <li v-for="(item,index) in dataList" :key="index">
              <div class="modal">
                <div class="left">
                  <p @click="gis('hszs',item.name)">{{item.name}}</p>
                  <el-row :gutter="20">
                    <el-col :span="12">
                      <div class="grid-content bg-purple"><span>负责人</span><span>{{item.contact}}</span></div>
                    </el-col>
                    <el-col :span="12">
                      <div class="grid-content bg-purple"><span>值班电话</span><span>{{item.telephone}}</span></div>
                    </el-col>
                    <el-col :span="12">
...
<script>
  ...
  import {lists} from '@/api/station.js'
  import pagination from '@/components/pagination/index'
  import det from '@/views/dashboard/level_two/essential/station/details'
