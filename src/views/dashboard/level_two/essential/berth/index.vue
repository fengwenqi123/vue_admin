              ...
              <div class="modal">
                <div class="left">
                  ...
                  <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                      <div class="grid-content bg-purple"><span>投产日期：</span><span>{{item.productionDate}}</span></div>
                    </el-col>
                    <el-col :span="12">
                      <div class="grid-content bg-purple"><span>联系电话：</span><span>{{item.telephone}}</span></div>
                    </el-col>
                    <el-col :span="12">
                      <div class="grid-content bg-purple"><span>所属码头编号：</span><span>{{item.pierNo}}</span></div>
                    </el-col>
                  </el-row>
                </div>
                <div class="right">
...
<script>
  ...
  import {lists} from '@/api/berth.js'
  import pagination from '@/components/pagination/index'
  import det from '@/views/dashboard/level_two/essential/berth/details'
