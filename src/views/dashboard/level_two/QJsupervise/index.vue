            ...
            <li v-for="(item,index) in dataList" :key="index">
              <div class="modal">
                <div class="left">
                  ...
                  <el-row>
                    <el-col :span="24">
                      <div class="grid-content bg-purple"><span>创建人:</span><span>{{item.userName}}（{{item.departmentName}}）</span>
                      </div>
                    </el-col>
                    <!--<el-col :span="12">-->
                    <!--<div class="grid-content bg-purple"><span>布控开始时间:</span><span>{{item.warnStartTime}}</span></div>-->
                    <!--</el-col>-->
                    <!--<el-col :span="12">-->
                    <!--<div class="grid-content bg-purple"><span>布控结束时间:</span><span>{{item.warnEndTime}}</span></div>-->
                    <!--</el-col>-->
                    <el-col :span="24">
                ...
                <div class="right">
                  <svg-icon icon-class="dingwei" @click.native="gis('marea',item.name)"></svg-icon>
                </div>
              </div>
            </li>
          </el-scrollbar>
...
<script>
  ...
  import xqing from '@/views/dashboard/level_two/QJsupervise/xqing'
