<template>
  <div class="DepManagement">
    ...
    <el-card class="main">
        ...
        <div class="table">
          <el-table
            ...
            <el-table-column
              ...
              width="400">
              <template slot-scope="scope">
                <div class="nei" :style="{paddingLeft:scope.row.layer.length*10+'px'}" @click="openDetails(scope.row)"
      ...
      <add-dep v-if="!show" @ievent="ievent" :mul="mul" :disabled="disabled"></add-dep>
    </el-card>
  </div>
</template>
...
<script>
  ...
  import addDep from '@/views/DepManagement/addDep'
  ...
  export default {
    ...
    methods: {
      ...
      <p><span class="font">部门编号:</span><span>${row.code}</span></p>
