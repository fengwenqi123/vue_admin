<template>
  <div class="DicManagement">
    ...
    <el-card class="main">
        ...
        <div class="table">
          <el-table
            ...
            <el-table-column
              ...
              label="分类">
              <template slot-scope="scope">
                <div class="nei" @click="openDetails(scope.row)">{{scope.row.classification}}</div>
              </template>
            </el-table-column>
            <el-table-column
              prop="itemName"
      ...
      <add-dic v-if="!show" @ievent="ievent" :mul="mul" :disabled="disabled"></add-dic>
    </el-card>
  </div>
</template>
...
<script>
  ...
  import addDic from '@/views/DicManagement/addDic'
  ...
  export default {
    ...
    methods: {
      ...
      openDetails(row) {
        this.$confirm(`<div>
      <p><span class="font">分类:</span><span>${row.classification}</span></p>
      <p><span class="font">项目名称:</span><span>${row.itemName}</span></p>
      <p><span class="font">项目值:</span><span>${row.itemValue}</span></p>
      <p><span class="font">排序:</span><span>${row.sort}</span></p>
       <p><span class="font">类型:</span><span>${row.type}</span></p>
