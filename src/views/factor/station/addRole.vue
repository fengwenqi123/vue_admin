<template>
  <div class="roleModification">
    ...
    <el-form ref="form" :model="form" label-width="210px" label-suffix=":">
      ...
      <el-form-item label="所属市级港航管理机构  ">
        <el-input v-model="form.cityAgency"></el-input>
      </el-form-item>
      ...
      <el-form-item label="所属县（区）级港航管理机构  ">
        <el-input v-model="form.countyAgency"></el-input>
      </el-form-item>
      ...
      <el-form-item label="职能  ">
        <el-input v-model="form.functionWork"></el-input>
      </el-form-item>
...
<script>
  ...
  import {mod} from '@/api/station.js'
