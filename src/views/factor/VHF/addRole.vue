<template>
  <div class="roleModification">
    ...
    <el-form ref="form" :model="form" label-width="210px" label-suffix=":">
      ...
      <el-form-item label="	作用距离(海里)  ">
        <el-input v-model="form.limitDist"></el-input>
      </el-form-item>
      <el-form-item label="	VHF报告频道">
        <el-input v-model="form.reportChannel"></el-input>
      </el-form-item>
